...
int main()
{
	...
	double **my_matrix = new double *[MATRIX_SIZE];
	InitMatrix(my_matrix);
	// цикл по строкам
	...
	*/
	ParallelGaussMethod(my_matrix, MATRIX_SIZE, result);
